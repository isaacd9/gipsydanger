...
use gipsydanger\peopleBundle\Model\map\UsersTableMap;
...
abstract class BaseUsersPeer
{
    ...
    const OM_CLASS = 'gipsydanger\\peopleBundle\\Model\\Users';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Fname', 'Lname', 'Password', 'Salt', 'Email', 'IsActive', 'RoleId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fname', 'lname', 'password', 'salt', 'email', 'isActive', 'roleId', ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID, UsersPeer::FNAME, UsersPeer::LNAME, UsersPeer::PASSWORD, UsersPeer::SALT, UsersPeer::EMAIL, UsersPeer::IS_ACTIVE, UsersPeer::ROLE_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FNAME', 'LNAME', 'PASSWORD', 'SALT', 'EMAIL', 'IS_ACTIVE', 'ROLE_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'fname', 'lname', 'password', 'salt', 'email', 'is_active', 'role_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Fname' => 1, 'Lname' => 2, 'Password' => 3, 'Salt' => 4, 'Email' => 5, 'IsActive' => 6, 'RoleId' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fname' => 1, 'lname' => 2, 'password' => 3, 'salt' => 4, 'email' => 5, 'isActive' => 6, 'roleId' => 7, ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::ID => 0, UsersPeer::FNAME => 1, UsersPeer::LNAME => 2, UsersPeer::PASSWORD => 3, UsersPeer::SALT => 4, UsersPeer::EMAIL => 5, UsersPeer::IS_ACTIVE => 6, UsersPeer::ROLE_ID => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FNAME' => 1, 'LNAME' => 2, 'PASSWORD' => 3, 'SALT' => 4, 'EMAIL' => 5, 'IS_ACTIVE' => 6, 'ROLE_ID' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'fname' => 1, 'lname' => 2, 'password' => 3, 'salt' => 4, 'email' => 5, 'is_active' => 6, 'role_id' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersPeer::FNAME);
            $criteria->addSelectColumn(UsersPeer::LNAME);
            $criteria->addSelectColumn(UsersPeer::PASSWORD);
            $criteria->addSelectColumn(UsersPeer::SALT);
            $criteria->addSelectColumn(UsersPeer::EMAIL);
            $criteria->addSelectColumn(UsersPeer::IS_ACTIVE);
            $criteria->addSelectColumn(UsersPeer::ROLE_ID);
        } else {
    ...
    /**
     * Returns the number of rows matching criteria, joining the related Roles table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinRoles(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UsersPeer::ROLE_ID, RolesPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Users objects pre-filled with their Roles objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinRoles(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        UsersPeer::addSelectColumns($criteria);
        $startcol = UsersPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = UsersPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = UsersPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                UsersPeer::addInstanceToPool($obj1, $key1);
            } // if $obj1 already loaded

            $key2 = RolesPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = RolesPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    RolesPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Users) to $obj2 (Roles)
                $obj2->addUsers($obj1);
    ...
    /**
     * Selects a collection of Users objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        UsersPeer::addSelectColumns($criteria);
        $startcol2 = UsersPeer::NUM_HYDRATE_COLUMNS;

        RolesPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + RolesPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined Roles rows

            $key2 = RolesPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = RolesPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (Users) to the collection in $obj2 (Roles)
                $obj2->addUsers($obj1);
